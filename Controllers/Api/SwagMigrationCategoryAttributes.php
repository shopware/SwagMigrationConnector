...
class Shopware_Controllers_Api_SwagMigrationCategoryAttributes extends SwagMigrationApiControllerBase
{
    public function indexAction()
    {
        ...
        $attributeConfiguration = $this->container
            ...
            ->getAttributeConfiguration('s_categories_attributes')
        ;
