...
class Shopware_Controllers_Api_SwagMigrationCustomerGroupAttributes extends SwagMigrationApiControllerBase
{
    public function indexAction()
    {
        ...
        $attributeConfiguration = $this->container
            ...
            ->getAttributeConfiguration('s_core_customergroups_attributes')
        ;
