...
class Shopware_Controllers_Api_SwagMigrationManufacturerAttributes extends SwagMigrationApiControllerBase
{
    public function indexAction()
    {
        ...
        $attributeConfiguration = $this->container
            ...
            ->getAttributeConfiguration('s_articles_supplier_attributes')
        ;
