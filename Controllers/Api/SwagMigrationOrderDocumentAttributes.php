...
class Shopware_Controllers_Api_SwagMigrationOrderDocumentAttributes extends SwagMigrationApiControllerBase
{
    public function indexAction()
    {
        ...
        $attributeConfiguration = $this->container
            ...
            ->getAttributeConfiguration('s_order_documents_attributes')
        ;
