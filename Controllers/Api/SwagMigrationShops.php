...
class Shopware_Controllers_Api_SwagMigrationShops extends Shopware_Controllers_Api_Rest
{
    /**
    ...
    {
        $shopService = $this->container->get('swag_migration_assistant.service.shop_service');
